(function () {
    'use strict';
    angular.module("demo", ['ngRoute', 'CommonServices', 'demoservice','myApp.CommonDirectives']);
    ...
    function demoCtlr($scope, $q, demoService) {
        ...
        //    $('#example').DataTable({
        //        "ajax": "http://localhost:50720/api/Employee/GetEmployee"
        //    });
        //});
        ...
        function init() {
            return demoService.GetGridData().then(function(data) {
                debugger;
                if (data) {
                    $scope.data = data;
                }
